...
def main() -> None:
    config = DatasetConfig(
        ...
        v3_full_root=Path.home() / "ros2_ws/bev_dataset/yolo_obb_v3b_full",
        v3_tiled_root=Path.home() / "ros2_ws/bev_dataset/yolo_obb_v3b_tiled",
        seed=42,
        tile_size_px=1024,
        tile_overlap_ratio=0.25,
        train_object_jitter_tiles_per_object=0,
