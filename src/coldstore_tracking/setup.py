...
setup(
    ...
    data_files=[
        ...
        ('share/coldstore_tracking/config', glob('config/*.yaml') + glob('config/*.png')),
    ],
    ...
    entry_points={
        'console_scripts': [
            ...
            'floorplan_calibration_tool_node = coldstore_tracking.floorplan_calibration_tool_node:main',
            'coldstore_api_bridge_node = coldstore_tracking.coldstore_api_bridge_node:main',
